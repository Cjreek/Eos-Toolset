...
namespace Eos.Usercontrols
{
    public partial class AreaEffectComboBox : UserControl
    {
        ...
        public static readonly StyledProperty<AreaEffect?> SelectedValueProperty = AvaloniaProperty.Register<AreaEffectComboBox, AreaEffect?>("SelectedValue", null, false, BindingMode.TwoWay);
        public static readonly StyledProperty<bool> IsNullableProperty = AvaloniaProperty.Register<AreaEffectComboBox, bool>("IsNullable", true);
