...
namespace Eos.Usercontrols
{
    public partial class SpellComboBox : UserControl
    {
        ...
        public static readonly StyledProperty<Spell?> SelectedValueProperty = AvaloniaProperty.Register<SpellComboBox, Spell?>("SelectedValue", null, false, Avalonia.Data.BindingMode.TwoWay);
        public static readonly StyledProperty<bool> IsNullableProperty = AvaloniaProperty.Register<SpellComboBox, bool>("IsNullable", true);
        ...
        {
            var viewModel = new SpellSearchViewModel(MasterRepository.Spells);
