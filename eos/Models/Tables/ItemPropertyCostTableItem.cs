...
{
    public class ItemPropertyCostTableItem : TableItem
    {
        ...
        public ItemPropertyCostTableItem() : base()
        {
        ...
        public ItemPropertyCostTableItem(ItemPropertyCostTable parentTable) : base(parentTable)
        {
