...
{
    public class CustomDynamicTableInstanceItem : TableItem
    {
        ...
        public CustomDynamicTableInstanceItem() : base() 
        {
        ...
        public CustomDynamicTableInstanceItem(CustomDynamicTableInstance parentTable) : base(parentTable)
        {
